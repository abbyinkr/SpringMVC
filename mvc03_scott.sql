...
--○ 샘플 데이터 입력
INSERT INTO TBL_MEMBERLIST(MID, NAME, TELLPHONE)
VALUES(MEMBERLISTSEQ.NEXTVAL, '김서현', '010-1111-1111');
--> 한 줄 구성
INSERT INTO TBL_MEMBERLIST(MID, NAME, TELLPHONE) VALUES(MEMBERLISTSEQ.NEXTVAL, '김서현', '010-1111-1111')
;
--==>> 1 행 이(가) 삽입되었습니다.
INSERT INTO TBL_MEMBERLIST(MID, NAME, TELLPHONE) VALUES(MEMBERLISTSEQ.NEXTVAL, '이희주', '010-2222-2222')
;
--==>> 1 행 이(가) 삽입되었습니다.
...
--○ 목록 조회 쿼리문 구성
SELECT MID, NAME, TELLPHONE
FROM TBL_MEMBERLIST
ORDER BY MID;
--> 한 줄 구성
SELECT MID, NAME, TELLPHONE FROM TBL_MEMBERLIST ORDER BY MID
;
--==>>
/*
1	김서현	010-1111-1111
